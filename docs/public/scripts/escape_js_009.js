        ...
        console.log('prompt>>'+userMessage)
          ...
          fetch('https://api.openai.com/v1/chat/completions', {
              ...
              body: JSON.stringify({
                  ...
                  "messages": [
                      {"role": "system", "content": "As an expert provide detailed content for 40hours of online course with tests" }, //You are a poetic assistant, skilled in explaining complex programming concepts with creative flair.
